...
export default function SubmitTestimonialPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-6 py-16">
      <div className="max-w-lg w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-white/[0.025] border border-white/[0.07] rounded-2xl p-6">
          ...
          <div>
            <label className="block text-xs text-zinc-500 uppercase tracking-wider mb-1.5">Profile Photo (optional)</label>
            <ImageUploadField
